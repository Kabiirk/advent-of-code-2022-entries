...
function full_overlap(range_pairs, part2){
    /*
    E.g.:
...
function partial_overlap(range_pairs, part2){
    /*
    E.g.:
    range_pairs = [82, 83, 78, 82]
...
// Part 2
let partially_contained = parsed_input.map(partial_overlap).reduce((a, b) => a + b, 0);
console.log(partially_contained);